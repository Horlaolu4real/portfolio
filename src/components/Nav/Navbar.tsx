    ...
    >
      <div className="page_container flex items-center justify-between py-4">
        <Link
          ...
          className="group inline-flex items-center gap-2 px-1 py-2 text-sm text-[color:var(--text-primary)] transition-all duration-300"
        >
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.96 }}
            className="inline-flex items-center gap-2 rounded-full border border-[color:var(--accent)]/40 px-5 py-2.5 text-sm font-semibold text-[color:var(--accent-ink)] transition-all duration-300 hover:border-[color:var(--accent)] hover:text-[color:var(--text-primary)]"
          >
            Resume ↗
          </motion.a>
        </div>
        ...
        <div className="flex items-center gap-1 md:hidden">
          ...
          <button
            ...
            className="flex h-10 w-10 flex-col justify-center gap-[5px] p-2"
          ...
          >
            <motion.span
              ...
              className="block h-[2px] w-full rounded-full bg-[color:var(--text-primary)] origin-center"
            />
            <motion.span
              animate={{ opacity: menuOpen ? 0 : 1, scaleX: menuOpen ? 0 : 1 }}
              transition={{ duration: 0.2 }}
              className="block h-[2px] w-full rounded-full bg-[color:var(--text-primary)]"
            />
            <motion.span
              animate={menuOpen ? { rotate: -45, y: -7 } : { rotate: 0, y: 0 }}
              transition={{ duration: 0.25 }}
                ...
                >
                  <a
                    ...
                    className={[
                      ...
                      activeLink === href
                        ? "bg-[color:var(--bg-subtle-2)] text-[color:var(--text-primary)]"
